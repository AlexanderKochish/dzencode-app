...
const translations: Array<{ locale: string; namespace: string; key: string; value: string }> = [
  ...
  { locale: 'ru', namespace: 'common', key: 'loading',       value: 'Загрузка...' },
  ...
  { locale: 'ru', namespace: 'common', key: 'push_blocked_tooltip',   value: 'Уведомления заблокированы в настройках браузера' },
  { locale: 'ru', namespace: 'common', key: 'push_blocked_label',     value: 'Заблокировано' },
  { locale: 'ru', namespace: 'common', key: 'push_disable_tooltip',   value: 'Отключить push-уведомления' },
  { locale: 'ru', namespace: 'common', key: 'push_enabled_label',     value: 'Уведомления вкл.' },
  { locale: 'ru', namespace: 'common', key: 'push_enable_tooltip',    value: 'Включить push-уведомления' },
  { locale: 'ru', namespace: 'common', key: 'push_disabled_label',    value: 'Уведомления' },

  { locale: 'en', namespace: 'common', key: 'push_blocked_tooltip',   value: 'Notifications are blocked in browser settings' },
  { locale: 'en', namespace: 'common', key: 'push_blocked_label',     value: 'Blocked' },
  { locale: 'en', namespace: 'common', key: 'push_disable_tooltip',   value: 'Disable push notifications' },
  { locale: 'en', namespace: 'common', key: 'push_enabled_label',     value: 'Notifications on' },
  { locale: 'en', namespace: 'common', key: 'push_enable_tooltip',    value: 'Enable push notifications' },
  { locale: 'en', namespace: 'common', key: 'push_disabled_label',    value: 'Notifications' },
